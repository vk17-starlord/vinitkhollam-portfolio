...
<div className="min-h-[50vh] pt-[10vh] w-full rounded-md flex items-center justify-center bg-black/[0.96] top-0 antialiased bg-grid-white/[0.02] relative overflow-hidden">
      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
        ...
        I Make 
        <FlipWords className="text-yellow-50" words={words} /> 
        <br />
        Websites So You Don&apos;t Have To
        </h1>
        <p className="my-10 font-normal text-lg  text-neutral-300 max-w-lg text-center mx-auto">
                <span className="text-gray-300">
          Built with more bugs than features, my portfolio highlights
          <span className="font-bold text-white"> pixel-perfect </span>
          designs,
          <span className="font-bold text-white"> questionable </span>
          React skills, and
          <span className="font-bold text-white"> WordPress magic </span>
          that even AI can&apos;t replace... yet.
        </span>
       </p>
